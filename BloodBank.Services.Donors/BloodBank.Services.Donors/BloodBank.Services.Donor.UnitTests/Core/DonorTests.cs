...
public class DonorTests
{
    ...
    public void DonorShouldNotAppearAfterSetAsDeleted()
    {
        ...
        {
            new Donor("Alice", "alice@email.com", new DateTime(1990, 1, 1), Gender.Female, 60, BloodType.O, RhFactor.Positive, new Address("Street 1", "1", "CityA", "ST", "00001")),
            new Donor("Bob", "bob@email.com", new DateTime(1985, 5, 5), Gender.Male, 80, BloodType.B, RhFactor.Negative, new Address("Street 2", "2", "CityB", "ST", "00002"))
        };

        var donorToDelete = new Donor("Teste douglas", "teste@email.com", new DateTime(2002, 7, 17, 14, 30, 0), Gender.Male, 76, BloodType.A, RhFactor.Negative, new Address("Rua Caralinhos", "10", "Poa", "RS", "918827"));
